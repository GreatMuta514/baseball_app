...
ActiveRecord::Schema.define(version: 20_221_031_094_644) do
  ...
  create_table 'pro_game_predict_comments', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.integer 'parent_id'
    t.integer 'pro_game_predict_id'
    t.index ['parent_id'], name: 'index_pro_game_predict_comments_on_parent_id'
    t.index ['pro_game_predict_id'], name: 'index_pro_game_predict_comments_on_pro_game_predict_id'
  ...
  add_foreign_key 'pro_game_predict_comments', 'pro_game_predicts'
